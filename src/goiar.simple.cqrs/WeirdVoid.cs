...
namespace Goiar.Simple.Cqrs
{
    ...
    /// </summary>
    public class WeirdVoid : IEquatable<WeirdVoid>, IComparable<WeirdVoid>, IComparable
    {
        /// <summary>
        /// Default and only value of the <see cref="WeirdVoid"/> type.
        /// </summary>
        public static readonly WeirdVoid Value = new WeirdVoid();

        /// <summary>
        /// Task from a <see cref="WeirdVoid"/> type.
        /// </summary>
        public static readonly Task<WeirdVoid> Task = System.Threading.Tasks.Task.FromResult(Value);
        ...
        /// </returns>
        public int CompareTo(WeirdVoid other) => 0;
        ...
        /// </returns>
        public bool Equals(WeirdVoid other) => true;
        ...
        /// </returns>
        public override bool Equals(object obj) => obj is WeirdVoid;
        ...
        public static bool operator ==(WeirdVoid first, WeirdVoid second)
        {
            return true;
        }
